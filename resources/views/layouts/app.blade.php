...
<body class="bg-[#F8FAFC] text-gray-800 h-screen overflow-hidden">

    <!-- BEGIN: MainHeader -->
    <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 z-10" data-purpose="top-navbar">
        <!-- Logo Text Area -->
        ...
        <form action="{{ route('inventory.index') }}" class="flex-1 max-w-xl mx-8 relative" id="inventory-search" method="GET">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                </svg>
            </div>
            <input class="block w-full pl-10 pr-3 py-2 border border-gray-100 rounded-lg leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors" name="search" placeholder="Cari produk, transaksi, laporan..." type="text" value="{{ $search ?? '' }}" />
        </form>
        @endif
        ...
        <div class="flex items-center space-x-5">
            ...
            <button class="text-gray-400 hover:text-gray-500 relative">
                ...
                <span class="absolute top-0 right-0 block h-4 w-4 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center transform translate-x-1 -translate-y-1">3</span>
            </button>
            ...
            <div class="flex items-center space-x-3 border-l pl-5 border-gray-200">
                <img alt="User Avatar" class="h-8 w-8 rounded-full object-cover border border-gray-200 bg-gray-100" src="https://lh3.googleusercontent.com/aida-public/AB6AXuASaThGtpL0MUG5_G9b0uQ7z1jZRbonGeqvGgJzvhy0QaBok3zCv33d36FEEzkB81Ep0QmHxoyHHuhu0AORseDF7_-5SPJ2UTll04FX1oIa2cNBfLWkZ0-tXUqdGJ_oqFNmrL11bagKrnCT79FGwijKzOu7jzdJ4OVwXupsw330JOnvY32-PWD5UuyAzvvolmIrT-XCTDGbctGpSAme-wxRiZAvTduj3gwL1g4UrtJrjIJ7Bg-vqlZbD_Nmsr5GxAv8sAy8J1Xt-G0" />
    ...
    <div class="flex h-[calc(100vh-4rem)] overflow-hidden">
        <!-- BEGIN: Sidebar -->
        <aside class="w-20 bg-white border-r border-gray-200 flex flex-col items-center py-6 flex-shrink-0 z-20" data-purpose="main-sidebar">
            <!-- Logo Icon (Dummy) -->
            ...
            <nav class="flex flex-col space-y-4 w-full">
                <!-- Home -->
                <a class="flex justify-center items-center w-full py-3 text-gray-400 hover:text-gray-600 transition-colors" href="#">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="relative flex justify-center items-center w-full py-3">
                    ...
                    <a class="bg-blue-50 text-blue-600 p-2 rounded-lg flex justify-center items-center relative group" href="{{ route('inventory.index') }}">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
