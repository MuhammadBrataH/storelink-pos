...
<head>
    ...
    <title>Admin - Storelink POS</title>
...
<body class="min-h-screen bg-slate-50 p-6">
    <div class="max-w-4xl mx-auto bg-white border border-slate-200 rounded-lg p-6">
        <h1 class="text-2xl font-semibold text-slate-900">Sapaan Utama Admin</h1>
        <p class="text-slate-600 mt-2">Arahkan admin ke Dashboard Analitik, Inventory, dan POS.</p>
