        ...
        <form action="{{ route('inventory.update', $product) }}" class="space-y-8" enctype="multipart/form-data" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div class="space-y-4 lg:col-span-2">
                    ...
                    <label class="border-2 border-dashed border-brand-border rounded-xl bg-gray-100 p-4 flex justify-center items-center h-64">
                        <img alt="Foto Produk" class="max-h-full object-contain mix-blend-multiply" id="image-preview" src="{{ $product->image_url ?: 'https://via.placeholder.com/240x240' }}" />
            ...
            <section>
                ...
                <div class="space-y-4" id="variation-rows">
                    ...
                    <div class="grid grid-cols-5 gap-4">
                        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[{{ $index }}][size]" placeholder="Ukuran (S/M/L)" type="text" value="{{ $variation['size'] ?? '' }}" />
                        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[{{ $index }}][color]" placeholder="Warna" type="text" value="{{ $variation['color'] ?? '' }}" />
                        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[{{ $index }}][price_capital]" placeholder="Harga modal" type="text" value="{{ $variation['price_capital'] ?? '' }}" />
                        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[{{ $index }}][price_sell]" placeholder="Harga jual" type="text" value="{{ $variation['price_sell'] ?? '' }}" />
                        <div class="flex items-center gap-2">
                            <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" min="0" name="variations[{{ $index }}][stock]" placeholder="Stok" type="number" value="{{ $variation['stock'] ?? '' }}" />
                            <button class="text-red-500 hover:text-red-700" type="button" data-remove-variation><i class="fa-regular fa-trash-can"></i></button>
                        </div>
                    </div>
                    @endforeach
                </div>
                <button class="mt-3 inline-flex items-center px-4 py-2 border border-brand-border rounded-md shadow-sm text-sm font-medium text-brand-text bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue" id="add-variation" type="button">
...
<template id="variation-row-template">
    <div class="grid grid-cols-5 gap-4">
        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[__INDEX__][size]" placeholder="Ukuran (S/M/L)" type="text" />
        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[__INDEX__][color]" placeholder="Warna" type="text" />
        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[__INDEX__][price_capital]" placeholder="Harga modal" type="text" />
        <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" name="variations[__INDEX__][price_sell]" placeholder="Harga jual" type="text" />
        <div class="flex items-center gap-2">
            <input class="w-full rounded-md border-brand-border focus:ring-brand-blue focus:border-brand-blue sm:text-sm h-10" min="0" name="variations[__INDEX__][stock]" placeholder="Stok" type="number" />
            <button class="text-red-500 hover:text-red-700" type="button" data-remove-variation><i class="fa-regular fa-trash-can"></i></button>
        </div>
    </div>
</template>
